...
//Nel caso di valori uguali quicksort si comporta come se fossero crescenti (degenerando a n^2)
//Per evitare che si degeneri in una situazione del genere bisogna modificare il modo in cui viene partizionato l'array
