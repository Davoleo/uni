...
HD_PWD='C:/Dev/uni/master/II/Lab0/Lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinker_v3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinker_v3.tcl
