...
HD_PWD='C:/Dev/uni/master/II/Lab0/Lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinker_v3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinker_v3.tcl -notrace
