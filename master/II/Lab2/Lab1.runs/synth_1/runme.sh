...
HD_PWD='C:/Dev/uni/master/II/Lab2/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinker_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinker_v2.tcl
