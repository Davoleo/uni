...
HD_PWD='C:/Dev/uni/master/II/Lab2/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinker_v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinker_v2.tcl -notrace
