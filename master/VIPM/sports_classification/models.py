...
class Baseline2(nn.Module):
    ...
    def forward(self, x):
        ...
        # dropout
        if self.training: # disabling dropout during inference
            x = nn.functional.dropout(x, 0.5)
...
class Baseline3(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3, padding=0)
        self.bn4 = nn.BatchNorm2d(512)
        self.pool4 = nn.MaxPool2d(kernel_size=2, stride=2)

        self.conv5 = nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, padding=0)
        self.bn5 = nn.BatchNorm2d(512)
        self.pool5 = nn.MaxPool2d(kernel_size=2, stride=2)
