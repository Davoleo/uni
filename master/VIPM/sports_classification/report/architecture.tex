...
\begin{frame}{Project Architecture}{Source Files}
  ...
  \begin{itemize}
    ...
    \item \texttt{evaluate.py}: Entrypoint for inference on all models.\pause\
...
\begin{frame}{Project Architecture}{Other Folders \& Files}
  \begin{itemize}
    ...
    \item \texttt{iterations.log}: Contains all model iterations and their relative results with comments and rationales.
  \end{itemize}
\end{frame}
...
\begin{frame}{ROCm and GPUs}
  \begin{block}{Hardware Note}
    In order to train the models we used \textbf{ROCm} (AMD's open source high performace compute library) on 2 AMD consumer cards: RX6950XT \& RX9070.
  ...
  \begin{itemize}
    ...
    \item \textbf{GPU RX6950XT}:\@ \texttt{uv sync --extra stable}
