...
int main(int argc, char *argv[])
{
  ...
  t_np = (double)(t_np2.tv_sec - t_np1.tv_sec) + (double)(t_np2.tv_nsec - t_np1.tv_nsec) / BILLION;

  t_p = (double)(t_p2.tv_sec - t_p1.tv_sec) + (double)(t_p2.tv_nsec - t_p1.tv_nsec) / BILLION;
