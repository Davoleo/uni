...
// Inizializzazione di un dato statico
int Elem::num_current_objects = 0;

void Elem::register_object(int id)
{
...
void Elem::unregister_object(int id)
{
...
int Elem::next_id()
{
	//Variabile locale statica che viene inizializzata solo una volta
