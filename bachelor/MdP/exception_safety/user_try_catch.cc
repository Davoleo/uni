...
// Sono try catch diversi da quelli di livello alto che servono invece per gestire
// l'errore
// Questi servono solo a:
// - mantenere il codice exception safe
// - mantenersi neutrale all'errore per lasciarlo gestire a chi è più in alto
